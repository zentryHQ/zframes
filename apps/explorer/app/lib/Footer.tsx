    ...
    <footer className="relative mt-24 border-t border-white/10">
      <div className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-12 sm:flex-row sm:items-start sm:justify-between">
        ...
        <nav className="grid grid-cols-2 gap-x-14 gap-y-2 text-sm">
          <span className="col-span-2 mb-1 text-xs font-medium uppercase tracking-widest text-white/30">
            Explore
          </span>
          <Link href="/" className="text-white/55 transition-colors hover:text-white">
            Gallery
          </Link>
          <Link href="/catalogue" className="text-white/55 transition-colors hover:text-white">
            Catalogue
          </Link>
          <Link href="/tinker" className="text-white/55 transition-colors hover:text-white">
            Tinker
          </Link>
          <Link href="/mine" className="text-white/55 transition-colors hover:text-white">
            My dashboards
          </Link>
        </nav>
      </div>
      <div className="border-t border-white/[0.06]">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 px-6 py-5 text-xs text-white/30 sm:flex-row sm:items-center sm:justify-between">
