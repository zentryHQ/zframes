...
/**
 * Every capability the demo provider answers, shared by the class and the
 * plugin manifest (`./manifest`) so the declaration can never drift from the
 * implementation. Deduplicated: the manifest is what `zframes providers`
 * prints, and a repeated line there reads as a bug.
 */
export const DEMO_CAPABILITIES: readonly Capability[] = [
  "quote-stream",
  "day-stats",
  "funding-history",
  "ohlcv",
...
export class MockMarketDataProvider implements MarketDataProvider {
  readonly name = "mock";
  readonly capabilities: readonly Capability[] = DEMO_CAPABILITIES;
