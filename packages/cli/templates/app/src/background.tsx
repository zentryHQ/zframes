 ...
 *
 * A scrim sits over the scene so frame text stays legible over the motion. If
 * the Unicorn SDK fails to load (offline, CDN down, bad projectId), nothing
 * renders here and the body's dark gradient shows through — graceful default.
 */
